...
ALLOWED_HOSTS = ['scraping-wiki.herokuapp.com', '*'] #'scraping-wiki.herokuapp.com'
...
INSTALLED_APPS = [
    ...
    #* My apps
    'apps.covers_creator.apps.CoversCreatorConfig',
    'apps.rest_api.apps.RestApiConfig',
    'apps.scraping_wiki.apps.ScrapingWikiConfig',
